                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- <div class="form-group">
                            ...
                            @if ($product->photo)
                                <img src="{{ asset($product->photo) }}" alt="Photo" class="img-fluid mt-2" style="max-width: 100px;">
                            @endif
                        </div> --}}
                        <div class="form-group">
                            ...
                            @if ($product->photo)
                                ...
                                <div class="mt-2">
                                    @foreach ($photos as $photo)
                                        <img src="{{ asset($photo) }}" alt="Product Photo" class="img-fluid" style="max-width: 100px; margin-right: 10px;">
                                    @endforeach
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="condition" name="condition" value="{{ old('condition', $product->condition) }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="checkbox" id="is_featured" name="is_featured" {{ old('is_featured', $product->is_featured) ? 'checked' : '' }}>
                        </div>
                        <div class="form-group">
