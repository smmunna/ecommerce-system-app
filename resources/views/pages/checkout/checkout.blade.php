                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="order-notes">
                                <textarea class="input" name="order_note" placeholder="Order Notes or any important message"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5 order-details">
                            ...
                            <button type="submit" class="primary-btn order-submit">Proceed to Checkout</button>
                        </div>
                    </div>
                </div>
            </form>
